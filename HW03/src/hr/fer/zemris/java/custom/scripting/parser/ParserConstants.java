...
/**
 * The Class ParserConstans offers a few string constants and each of them represents some pattern.
 * 
 * @author Vjeco
 *
 */
public class ParserConstants {
	 ...
	 * Represents pattern for valid variable name. Starts with the letter followed by letters, numbers or _. 
	 */
	public static final String VARIABLE = "[a-z][\\w]*";
	...
	/** 
	 * The Constant VALID. 
	 * Represents pattern for any character that can "break" name of the variable or function in tag text.
	 */
