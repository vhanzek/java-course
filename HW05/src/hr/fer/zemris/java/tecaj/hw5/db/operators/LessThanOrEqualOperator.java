...
/**
 * The Class used for checking one {@link String} parameter is lesser or equal than the other.
 * This is one implementation of {@link IComparisonOperator} strategy.
 * 
 * @author Vjeco
 */
public class LessThanOrEqualOperator implements IComparisonOperator {

	/**
	 * Method returns <code>true</code> {@code value1} is 
	 * lesser or equal to {@code value2}.
	 *
	 * @param value1 the first string value
	 * @param value2 the second string value
	 * @return <code>true</code>, if {@code value1} 
	 * 			is lesser or equal to {@code value2}
	 */
	@Override
